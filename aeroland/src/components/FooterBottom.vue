                    ...
                    <div class="col-md-12">
                        <div class="horizontal-list text-center">
                            <ul>
                                ...
                                <li>
                                    <a href="tel:(+00)123567990" class="hover-style-link hover-style-link--sub-color">(+00) 123 567990</a>
                                </li>
                                <li>
                                    <a href="mailto:contact@aeroland.com" class="hover-style-link hover-style-link--sub-color">contact@aeroland.com</a>
                                </li>
                            </ul>
                        </div>
                    </div>
